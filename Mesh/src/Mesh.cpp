...
Mesh::Mesh(const std::vector<ShapeVertex> &vertices, Shader *shader, Texture *texture)
...
Mesh::Mesh(const std::vector<ShapeVertex> &vertices, const std::vector<uint32_t> &indexVer, Shader *shader, Texture *texture)
